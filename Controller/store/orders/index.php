...
// pagination
$items_per_page = 6;
$count_sql = "SELECT COUNT(id) as count from product";
            ...
            <div class="content">
                ...
                if ($orders_result) {
                    while ($row = mysqli_fetch_assoc($orders_result)) {
                        ...
                        <tbody>';
                        $products_sql = 'SELECT op.quantity as o_quantity,p.* FROM `order-product` as op INNER JOIN product as p ON op.productId=p.id WHERE op.orderId="' . $id . '"';
